...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.df_to_csv = QtWidgets.QTableWidget(self.csvPreview)
        self.df_to_csv.setEnabled(False)
        self.df_to_csv.setObjectName("df_to_csv")
        self.df_to_csv.setColumnCount(0)
        self.df_to_csv.setRowCount(0)
        self.gridLayout_7.addWidget(self.df_to_csv, 1, 0, 1, 1)
        self.exportButton = QtWidgets.QPushButton(self.csvPreview)
        self.exportButton.setObjectName("exportButton")
        self.gridLayout_7.addWidget(self.exportButton, 1, 1, 1, 1)
        self.lineEdit = QtWidgets.QLineEdit(self.csvPreview)
