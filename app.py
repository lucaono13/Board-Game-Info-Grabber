...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dfPreview = QtWidgets.QTableWidget(self.csvPreview)
        self.dfPreview.setEnabled(False)
        self.dfPreview.setObjectName("dfPreview")
        self.dfPreview.setColumnCount(0)
        self.dfPreview.setRowCount(0)
        self.gridLayout_7.addWidget(self.dfPreview, 1, 0, 1, 1)
